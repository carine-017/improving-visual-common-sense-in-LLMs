...
def main():
        ...
        for batch in tqdm(validation_loader, desc="Evaluating..."):
            ...
            if config.generate_images:
                ...
                if not valid_prompts:
                    ...
                    images = t2i_model(valid_prompts, num_inference_steps=35, guidance_scale=7.5, generator=torch.manual_seed(42)).images
            ...
            if pixel_values is not None:
                ...
                inputs['scores'] = compute_scores(clip_model, clip_processor, images, valid_prompts)
    ...
    if config.generate_images:
        ...
        print(f"Avg Clip Score: {avg_clip_scores:.3f}")
