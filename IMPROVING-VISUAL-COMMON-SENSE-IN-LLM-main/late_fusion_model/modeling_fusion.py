...
from .modeling_gpt2 import GPT2Block, GPT2PreTrainedModel
...
class MultimodalFusionLayer(GPT2PreTrainedModel, GenerationMixin): 
    """Modèle GPT2 avec capacités multimodales"""
    ...
    def __init__(self, config):
        ...
        # Désactiver les gradients pour le transformer principal
        self.transformer.requires_grad_(False)
        
        # Désactiver les gradients pour le modèle vision
        self.vision_model.requires_grad_(False)
        
        # Seuls ces composants seront entraînés
    ...
    def forward(
        ...
        token_type_ids: Optional[torch.LongTensor] = None, # added 
